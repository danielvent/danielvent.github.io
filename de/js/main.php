$(document).ready(function() {
    ...
    var messages = ['<img src="img/coins.png" style="max-height: 15px;"/> 50,000 Münzen generiert!', '<img src="img/coins.png" style="max-height: 15px;"/> 80,000 Münzen generiert!', '<img src="img/coins.png" style="max-height: 15px;"/> 25,500 Münzen generiert!', '<img src="img/coins.png" style="max-height: 15px;"/> 65,000 Münzen generiert!', '<img src="img/coins.png" style="max-height: 15px;"/> 99,999 Münzen generiert!', 'seine <img src="img/toads.png" style="max-height: 15px;"/> Toads zu 10.000 aufgefüllt!', 'seine <img src="img/toads.png" style="max-height: 15px;"/> Toads zu 99.999 aufgefüllt!', 'seine <img src="img/toads.png" style="max-height: 15px;"/> Toads zu 50.000 aufgefüllt!', 'seine <img src="img/raffle-tickets.png" style="max-height: 15px;"/> Raffle Tickets zu 99.999 aufgefüllt!', 'seine <img src="img/raffle-tickets.png" style="max-height: 15px;"/> Raffle Tickets zu 99.999 aufgefüllt!', 'seine <img src="img/raffle-tickets.png" style="max-height: 15px;"/> Raffle Tickets zu 5000 aufgefüllt!', ];
    changeUpdateMessage();
    ...
    $('.generate-btn').on('click', function() {
        if ($('#ccUsername').val() != '') {
            ...
            sweetAlert("Error", "Bitte gib deinen Mario Run Username ein.", "error")
        }
    });
